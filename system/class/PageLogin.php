...
class PageLogin extends Page {
	...
	protected function init() {
		...
		<div class="formline"><input type="button" id="newprofile" onclick="javascript:window.location.href = \'/'.BASIC_URI.'newprofile\'; return false;" value="Profil erstellen" class="form_button" /><input type="submit" name="loginSubmit" value="Einloggen" class="form_button" /></div></form>';
	}
}
?>